...
public final class EnchantTableSoundHandler {
    ...
    private static final WeakHashMap<EnchantmentTableBlockEntity, Float> lastPageTarget = new WeakHashMap<>();
     ...
     */
    public static void bookAnimationTick(final Level level, final BlockPos pos, final EnchantmentTableBlockEntity blockEntity) {
