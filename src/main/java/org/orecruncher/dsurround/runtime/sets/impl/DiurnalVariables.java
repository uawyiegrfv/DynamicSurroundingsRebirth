...
public class DiurnalVariables extends VariableSet<IDiurnalVariables> implements IDiurnalVariables {
    ...
    public void update(IVariableAccess variableAccess) {
        ...
        if (GameUtils.isInGame()) {
            ...
            // 26.1: getOverworldClockTime() is cumulative across days; reduce to today's phase.
            // DS angle convention is 0=noon, clock tick 0 is dawn: offset by -6 hours.
            this.celestialAngle = ((world.getOverworldClockTime() % 24000L + 18000L) % 24000L) / 24000F;
        } else {
            this.isDay = false;
            this.isNight = false;
