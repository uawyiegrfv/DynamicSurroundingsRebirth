...
public record SoundMappingConfigRule(ResourceLocation soundEvent, List<MappingRule> rules) {
    ...
    public record MappingRule(List<IMatcher<BlockState>> blocks, ResourceLocation factory, List<ResourceLocation> accent) {
        ...
        public static final Codec<MappingRule> CODEC = RecordCodecBuilder.create((instance) ->
                instance.group(
                        ...
                        IdentityUtils.CODEC.fieldOf("factory").forGetter(MappingRule::factory),
                        Codec.list(IdentityUtils.CODEC).optionalFieldOf("accent", ImmutableList.of()).forGetter(MappingRule::accent))
