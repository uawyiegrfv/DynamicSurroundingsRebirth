...
public class DiagnosticsOverlay extends AbstractOverlay {
    ...
    private void drawText(GuiGraphicsExtractor graphics, ObjectArray<FormattedCharSequence> text, boolean left) {
        ...
        for (j = 0; j < text.size(); ++j) {
            ...
            graphics.text(textRenderer, component, l, m, FOREGROUND_COLOR, false);
        }
    }
}
