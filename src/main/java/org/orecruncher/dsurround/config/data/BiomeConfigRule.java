...
public record BiomeConfigRule(
        ...
        boolean clearSounds,
        boolean resetFogColor,
        Optional<TextColor> fogColor,
        Optional<TextColor> dustColor,
        ...
        public static final Codec<BiomeConfigRule> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
                        ...
                        Codec.BOOL.optionalFieldOf("clearTraits", false).forGetter(BiomeConfigRule::clearTraits),
                        ...
                        Codec.BOOL.optionalFieldOf("resetFogColor", false).forGetter(BiomeConfigRule::resetFogColor),
                        TextColor.CODEC.optionalFieldOf("fogColor").forGetter(BiomeConfigRule::fogColor),
                        TextColor.CODEC.optionalFieldOf("dustColor").forGetter(BiomeConfigRule::dustColor),
