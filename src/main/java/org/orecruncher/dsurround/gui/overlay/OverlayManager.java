...
public class OverlayManager {
    ...
    // 26.1: registered as a NeoForge GuiLayer; the callback now receives GuiGraphicsExtractor.
    public void render(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        var partialTick = deltaTracker.getGameTimeDeltaTicks();
        this.overlays.forEach(overlay -> overlay.render(graphics, partialTick));
    }
