...
public abstract class ConfigElement<T> {
    ...
    public static class BooleanValue extends PropertyValue<Boolean> {
        ...
        private static final Component YES = Component.translatable("gui.yes").withStyle(s -> s.withColor(TextColor.fromRgb(ColorPalette.GREEN.getValue())));
        private static final Component NO = Component.translatable("gui.no").withStyle(s -> s.withColor(TextColor.fromRgb(ColorPalette.RED.getValue())));
