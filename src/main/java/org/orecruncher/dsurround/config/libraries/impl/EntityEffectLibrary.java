...
public class EntityEffectLibrary implements IEntityEffectLibrary {
    ...
    public EntityEffectLibrary(ITagLibrary tagLibrary, IModLog logger) {
        ...
        // Ensure the default info is available before the first reload. A TAGS-scope
        // reload (e.g. on server connect) returns early and would otherwise leave
        // defaultInfo null, causing an NPE in getEntityEffectInfo().
