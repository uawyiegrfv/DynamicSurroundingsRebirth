...
public final class SoundLibrary implements ISoundLibrary {
    ...
    private static final Identifier SILENCE = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "silence");
    ...
    @Override
    public boolean isSoundRegistered(Identifier sound) {
    ...
    public Optional<SoundInstance> remapSound(SoundInstance soundInstance) {
        ...
        if (mappingRule != null) {
            ...
            if (soundFactory.isPresent()) {
                ...
                var volumeScale = isStepSound ? 1.0F : soundInstance.getVolume();
