...
public class Handlers {
    ...
    private void init() {
        ...
        this.register(AuroraEffectHandler.class);
        ...
        // Potion particle suppression is handled by MixinLivingEntity (updateEffectVisibility), not PotionParticleHandler.
        ...
        this.register(AreaBlockEffects.class); // drives RandomBlockEffectSystem which populates the BlockInfo cache (reflectance/occlusion) used by reverb
    ...
    public static void registerHandlers() {
        ...
        ContainerManager.getRootContainer()
            ...
            .registerSingleton(CritWordsLibrary.class)
