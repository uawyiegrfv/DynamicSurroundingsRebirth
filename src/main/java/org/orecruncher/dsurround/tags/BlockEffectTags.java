...
public class BlockEffectTags {
    ...
    // StepThroughBrushEffect.cropAt). 1.12.2 had no tag for these - its BlockMap carried
    // per-age macro entries for #wheat / #crop / #beets - so this tag is the modern
    // equivalent and anything tagged gets the same age semantics.
