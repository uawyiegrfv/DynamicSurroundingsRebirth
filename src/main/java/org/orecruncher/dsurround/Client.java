...
public final class Client {
    ...
    public void initializeClient() {
        ...
        // Register a reload listener so AssetLibraryEvent.RELOAD (Scope.RESOURCES) fires.
        // This is what loads the sound factories and other data-driven configuration.
        ReloadListenerRegistry.register(PackType.CLIENT_RESOURCES, new ReloadListener(), Identifier.fromNamespaceAndPath(Constants.MOD_ID, "reload"));
    ...
    public void onComplete(Minecraft client) {
        ...
        // Force instantiation of the fog calculator so its event registrations are active
