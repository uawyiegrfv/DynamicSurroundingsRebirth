...
public final class SoundFXUtils {
    ...
    /**
     * How many bounces could REACH the listener (clear straight line to the ear). This is what feeds the
     * send-cutoff weights, and is NOT the same quantity as {@link #lastReturnedBounces} - see the note in
     * traceReverb.
     */
     ...
     * It feeds the DISCRETE reflection tap (AL_EAXREVERB_REFLECTIONS_GAIN), not the diffuse sends - see
     * {@link #REFLECTION_DENSITY_GAIN} and the tap site in traceReverb.
     */
