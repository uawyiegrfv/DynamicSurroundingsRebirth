...
public class WaterRippleParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTick) {
        ...
        consumer.addVertex(x - half, y, z - half).setUv(u1, v1).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
        consumer.addVertex(x - half, y, z + half).setUv(u1, v0).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
        consumer.addVertex(x + half, y, z + half).setUv(u0, v0).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
        consumer.addVertex(x + half, y, z - half).setUv(u0, v1).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
    }
