...
public record SoundFactory(
        ...
        Optional<ResourceLocation> wander,
        Optional<ResourceLocation> jump) implements Comparable<ISoundFactory>, ISoundFactory {
    ...
    @Override
    public Optional<ResourceLocation> getWanderSound() {
        return this.wander;
    }

    @Override
    public Optional<ResourceLocation> getJumpSound() {
        return this.jump;
    }

    @Override
    public ResourceLocation getLocation() {
        // 26.1: SoundEvent.getLocation() → location() (Primer 11)
