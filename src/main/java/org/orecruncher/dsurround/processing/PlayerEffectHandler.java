...
public class PlayerEffectHandler extends AbstractClientHandler {
    ...
    private static final Identifier HEARTBEAT = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "player.heartbeat");
    private static final Identifier TUMMY = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "player.tummy");
