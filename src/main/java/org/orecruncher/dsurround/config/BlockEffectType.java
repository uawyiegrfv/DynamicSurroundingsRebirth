...
public enum BlockEffectType {
    ...
    FIREFLY("firefly",
            (chance, conditions) -> new BlockParticleEffectProducer(chance, conditions,
                    (world, state, pos, rand) -> new FireflyParticle((ClientLevel) world, pos.getX(), pos.getY() + 0.5D, pos.getZ()))),
    DUST_JET("dust", DustJetProducer::new);
    ...
    static {
        ...
        DUST_JET.setConfigProvider(() -> config.dustJetEnabled);
    }
}
