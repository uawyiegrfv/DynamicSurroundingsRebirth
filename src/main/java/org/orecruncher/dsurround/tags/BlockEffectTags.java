...
public class BlockEffectTags {
    ...
    // Open-work blocks that do not stop sound (iron bars, chains, panes): a grille roof or wall
    // must not read as "indoors". Vanilla has no tag for these (BlockTags.BARS is 1.21.2+).
