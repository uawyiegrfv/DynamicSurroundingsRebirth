...
public class ComplementsPointIterator implements IPointIterator {
    ...
    public ComplementsPointIterator(final BoundingBox volume, final BoundingBox intersect) {
        ...
        final BlockPos vmax = new BlockPos(volume.maxX(), volume.maxY(), volume.maxZ());
        final BlockPos imax = new BlockPos(intersect.maxX(), intersect.maxY(), intersect.maxZ());
        final BlockPos vmin = new BlockPos(volume.minX(), volume.minY(), volume.minZ());
        final BlockPos imin = new BlockPos(intersect.minX(), intersect.minY(), intersect.minZ());
