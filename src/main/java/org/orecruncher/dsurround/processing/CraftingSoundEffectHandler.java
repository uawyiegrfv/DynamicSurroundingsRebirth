...
public class CraftingSoundEffectHandler {
    ...
    private static final ResourceLocation CRAFTING = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "crafting");
    ...
    public void onItemCrafted(PlayerEvent.ItemCraftedEvent event) {
        ...
        Player player = event.getEntity(); // 1.20.1: PlayerEvent.getEntity() already returns Player
