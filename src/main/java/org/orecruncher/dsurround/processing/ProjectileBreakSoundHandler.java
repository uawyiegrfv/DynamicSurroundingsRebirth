...
public final class ProjectileBreakSoundHandler {
    ...
    private static final Identifier PEARL_BREAK = Identifier.fromNamespaceAndPath(
            Constants.MOD_ID, "projectile/pearl");
    private static final Identifier EGG_BREAK = Identifier.fromNamespaceAndPath(
            Constants.MOD_ID, "projectile/egg");
    private static final Identifier SNOWBALL_BREAK = Identifier.fromNamespaceAndPath(
