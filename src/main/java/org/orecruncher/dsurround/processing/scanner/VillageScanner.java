...
/**
 * 1.21.1: Villager lives directly in npc; entity queries use Level#getEntitiesOfClass(Class, AABB, Predicate);
 * DimensionType#natural was removed (proxy with hasSkyLight); BlockPos#closerToCenterThan was removed (use
 * Vec3#closerThan).
 */
public class VillageScanner extends AbstractScanner {
    ...
    public void tick(long tickCount) {
        ...
        if (world.dimensionType().hasSkyLight()) {
            ...
            var villagerEntities = world.getEntitiesOfClass(Villager.class, box, villager -> true);
