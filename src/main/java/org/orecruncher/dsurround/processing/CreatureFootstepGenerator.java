...
public class CreatureFootstepGenerator extends AbstractClientHandler {
     ...
     */
    private static ResourceLocation creatureFactory(final ResourceLocation loc) {
        ...
        if (path.startsWith("footsteps."))
            ...
            return loc;
        final ResourceLocation mono = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, monoPath);
