...
public class FootprintParticle extends TextureSheetParticle {
    ...
    // Per-entity print size, from the entity's Variator. variators.json already carries those values,
    // they were just never read.
    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTick) {
        ...
        consumer.addVertex(x + rx0, y, z + rz0).setUv(u1, v1).setColor(this.rCol, this.gCol, this.bCol, alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
        consumer.addVertex(x + rx1, y, z + rz1).setUv(u1, v0).setColor(this.rCol, this.gCol, this.bCol, alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
        consumer.addVertex(x + rx2, y, z + rz2).setUv(u0, v0).setColor(this.rCol, this.gCol, this.bCol, alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
        consumer.addVertex(x + rx3, y, z + rz3).setUv(u0, v1).setColor(this.rCol, this.gCol, this.bCol, alpha).setUv2((light) & 0xFFFF, ((light) >> 16) & 0xFFFF);
    }
